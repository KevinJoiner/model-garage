...
// ToPowertrainTractionBatteryTemperature0 converts data from field 'hvBatteryCoolantTemperature' of type float64 to 'Vehicle.Powertrain.TractionBattery.Temperature' of type .
// Vehicle.Powertrain.TractionBattery.Temperature: Temperature Information for the battery pack.
//   
func ToPowertrainTractionBatteryTemperature0(originalDoc []byte, val float64) (, error){
    panic("not implemented")
}
