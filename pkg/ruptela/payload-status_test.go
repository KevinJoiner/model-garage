	...
	fullInputJSON = `
{
	...
	expectedSignals = []vss.Signal{
		...
		{TokenID: 33, Timestamp: ts, Name: vss.FieldPowertrainType, ValueString: "0", Source: "ruptela/TODO"},
		{TokenID: 33, Timestamp: ts, Name: vss.FieldPowertrainFuelSystemRelativeLevel, ValueNumber: 0, Source: "ruptela/TODO"},
		{TokenID: 33, Timestamp: ts, Name: vss.FieldPowertrainTractionBatteryStateOfChargeCurrent, ValueNumber: 0xFF, Source: "ruptela/TODO"},
		{TokenID: 33, Timestamp: ts, Name: vss.FieldPowertrainRange, ValueNumber: 65535000, Source: "ruptela/TODO"},
		{TokenID: 33, Timestamp: ts, Name: vss.FieldExteriorAirTemperature, ValueNumber: 215, Source: "ruptela/TODO"},
		{TokenID: 33, Timestamp: ts, Name: vss.FieldPowertrainFuelSystemAbsoluteLevel, ValueNumber: 0xFFFF, Source: "ruptela/TODO"},
		{TokenID: 33, Timestamp: ts, Name: vss.FieldOBDRunTime, ValueNumber: 0, Source: "ruptela/TODO"},
		...
		{TokenID: 33, Timestamp: ts, Name: vss.FieldPowertrainTransmissionTravelledDistance, ValueNumber: 0xFFFFFFFF, Source: "ruptela/TODO"},
